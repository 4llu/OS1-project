...
/**
  ...
  */
class Penguin2 (x:Int, y:Int, world:World) extends Monster(x:Int, y:Int, world:World, 0.09, 25, 32) {
  ...
  def loadSprites() = {
    val penguinSprites = ImageIO.read(new File("media/penguin_blue.png"))
